    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Isi Survey Dapet UANG!</h5>
            ...
            <div class="modal-body text-justify text-dark">
                Kamu bisa dapetin uang lho dengan cara isi survei ini, Yuk segera buat akun kamu di Survit!
            </div>
